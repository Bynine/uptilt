...
public class MoveList_Kicker extends MoveList{
	...
	public Move sCharge() {
		...
		Hitbox h1 = new Hitbox(user, 6, 3.5f, 15, 60, 16, 4, 8, new SFX.HeavyHit(), c);
		Hitbox h2 = new Hitbox(user, 8, 4.5f, 18, 52, 26, 4, 8, new SFX.HeavyHit(), c);
		Hitbox h3 = new Hitbox(user, 9, 4.8f, 22, 42, 36, 4, 8, new SFX.HomeRun(), c);
	...
	public Move uCharge() {
		...
		Effect.Charge c = new Charge(3, 33, 0.02f, user, m);
		Hitbox h1 = new Hitbox(user, 4, 5.5f, 17, 90, 26,-16, 16, new SFX.HeavyHit(),  c);
		Hitbox h2 = new Hitbox(user, 4, 4.5f, 16, 87, 20, 16, 16, new SFX.HeavyHit(),  c);
		Hitbox h3 = new Hitbox(user, 3.5f, 4, 15, 84,  0, 26, 16, new SFX.MidHit(),  c);
		Hitbox h4 = new Hitbox(user, 3, 3.5f, 14, 70,-20, 16, 16, new SFX.MidHit(),  c);
		Hitbox h5 = new Hitbox(user, 2.5f, 3, 13, 30,-26,-16, 16, new SFX.LightHit(),  c);
	...
	public Move fThrow(){
		...
		m.setAnimation("sprites/player/sweak.png", 1, 1);
		m.dontTurn();
		Hitbox h1 = new Hitbox(user, 4.8f, 1.1f, 12, 50, 16, 0, 20, new SFX.MidHit());
	...
	public Move bThrow(){
		...
		m.dontTurn();
		Hitbox h1 = new Hitbox(user, 5, 1, 9, 100, 16, 0, 20, new SFX.MidHit());
		m.eventList.addActionCircle(h1, 0, 1);
		return m;
	}
	...
	public Move uThrow(){
		...
		Hitbox h1 = new Hitbox(user, 4, 2, 10, 90, 16, 0, 20, new SFX.MidHit());
		m.eventList.addActionCircle(h1, 0, 1);
		return m;
	}
	...
	public Move dThrow(){
		...
		m.dontTurn();
		Hitbox down = new Hitbox(user, 3, 0, 4, 270, 16, 0, 20, new SFX.LightHit());
		Hitbox up = new Hitbox(user, 3, 1.2f, 6, 82, 16, -8, 20, new SFX.MidHit());
	...
	public Move fAirThrow(){
		Move m = new Move(user, 18);
		m.setAnimation("sprites/player/fair.png", 1, 1);
		Hitbox h1 = new Hitbox(user, 3, 2.8f, 14, 30, 16, 0, 20, new SFX.MidHit());
		m.eventList.addActionCircle(h1, 0, 1);
		return m;
	}
	...
	public Move uAirThrow(){
		...
		Hitbox h1 = new Hitbox(user, 4, 1.5f, 13, 90, 16, 0, 20, new SFX.MidHit());
		m.eventList.addActionCircle(h1, 0, 1);
	...
	public Move dAirThrow(){
		...
		Hitbox down = new Hitbox(user, 4, 4, 15, 280, 16, 0, 20, new SFX.HeavyHit());
		m.eventList.addActionCircle(down, 0, 1);
	...
	public Move airDodge(){
		...
		m.setHelpless();
		m.dontTurn();
		m.setAnimation("sprites/player/ucharge.png", 4, 3);
		m.eventList.addInvincible(user, 11, 25);
		m.eventList.addConstantVelocity(user, 0, 10, user.direct() * user.getStickX() * boost, -user.getStickY() * boost);
		m.eventList.addConstantVelocity(user, 11, 21, 0, 0);
		m.eventList.addVelocityChange(user, 22, 0, 0);
		return m;
	}
	...
	public Move rollForward(){
		...
		user.flip();
		m.setAnimation("sprites/player/ucharge.png", 4, 8);
		m.eventList.addConstantVelocity(user, 2, 27, -8, Action.ChangeVelocity.noChange);
		m.eventList.addInvincible(user, 5, 30);
		return m;
	}
	...
	public Move taunt(){
		...
		m.setAnimation("sprites/player/taunt.png", 7, 8);
		return m;
	}
