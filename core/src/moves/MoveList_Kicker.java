...
public class MoveList_Kicker extends MoveList{
	...
	public Move uWeak(Fighter user) {
		...
		Hitbox knee = new Hitbox(user, 4, 0, 3, 90, 24, 0, 12, new SFX.LightHit());
		Hitbox kick = new Hitbox(user, 3, 2, 7, 85, 22, 28, 12, new SFX.MidHit());
	...
	public Move dWeak(Fighter user) {
		...
		Hitbox inner = new Hitbox(user, 3, 0.8f, 6, 76, 20, -9, 14, new SFX.LightHit());
		Hitbox outer = new Hitbox(user, 3, 0.8f, 7, 84, 34, -8, 12, new SFX.LightHit());
	...
	public Move slide(Fighter user) { 
		...
		Hitbox early = new Hitbox(user, 3, 3, 10, 65, 16, -4, 20, new SFX.HeavyHit());
	...
	public Move sCharge(Fighter user) {
		...
		Hitbox h1 = new Hitbox(user, 4, 4, 15, 60, 16, 4, 8, new SFX.HeavyHit(), c);
		Hitbox h2 = new Hitbox(user, 5, 5, 18, 52, 26, 4, 8, new SFX.HeavyHit(),  c);
		Hitbox h3 = new Hitbox(user, 6, 6, 22, 42, 36, 4, 10, new SFX.HeavyHit(),  c);
	...
	public Move uCharge(Fighter user) {
		...
		Effect.Charge c = new Charge(3, 33, 0.02f, user, m);
		Hitbox h1 = new Hitbox(user, 4, 5, 17, 90, 26,-16, 16, new SFX.HeavyHit(),  c);
		Hitbox h2 = new Hitbox(user, 4, 4, 16, 87, 20, 16, 16, new SFX.HeavyHit(),  c);
		Hitbox h3 = new Hitbox(user, 3, 4, 15, 84,  0, 26, 16, new SFX.MidHit(),  c);
		Hitbox h4 = new Hitbox(user, 3, 3, 14, 70,-20, 16, 16, new SFX.MidHit(),  c);
		Hitbox h5 = new Hitbox(user, 2, 3, 13, 30,-26,-16, 16, new SFX.LightHit(),  c);
	...
	public Move dCharge(Fighter user) {
		...
		m.setAnimation("sprites/player/dcharge.png", 4, 8);
		Effect.Charge c = new Charge(3, 33, 0.02f, user, m);
		m.eventList.addCharge(user, c);
		Hitbox front1 = new Hitbox(user, 4, 5, 14, 30, 20, 16, 8, new SFX.HeavyHit(),  c);
		Hitbox front2 = new Hitbox(user, 4, 4, 12, 30, 36, 16, 10, new SFX.HeavyHit(),  c);
		Hitbox back1 = new Hitbox(user, 4, 5, 14, 30, -20, 16, 8, new SFX.HeavyHit(),  c);
		Hitbox back2 = new Hitbox(user, 4, 4, 12, 30, -36, 16, 10, new SFX.HeavyHit(),  c);
	...
	public Move dAir(Fighter user) {
		...
		Hitbox h1 = new Hitbox(user, 2, 3, 11, 270, 10, 0, 14, new SFX.MidHit());
		Hitbox h2 = new Hitbox(user, 2, 4, 14, 285, 8, -24, 18, new SFX.MidHit());
	...
	public Move fAir(Fighter user) {
		...
		Hitbox early = new Hitbox(user, 3, 3, 14, 30, 24, 0, 16, new SFX.HeavyHit());
		Hitbox late = new Hitbox(user, 1, 2, 5, Hitbox.SAMURAIANGLE, 27, 0, 10, new SFX.LightHit());
	...
	public Move bAir(Fighter user) {
		...
		Hitbox early1 = new Hitbox(user, 3, 2.5f, 12, 40, -30, 6, 16, new SFX.MidHit());
		Hitbox early2 = new Hitbox(user, 3, 2.5f, 12, 40, -10, 6, 20, new SFX.MidHit());
		Hitbox late1 =  new Hitbox(user, 2, 1, 8, Hitbox.SAMURAIANGLE, -32, 6, 12, new SFX.LightHit());
		Hitbox late2 =  new Hitbox(user, 2, 1, 8, Hitbox.SAMURAIANGLE, -10, 6, 14, new SFX.LightHit());
	...
	public Move uSpecial(Fighter user) {
		...
		m.setAnimation("sprites/player/uspecial.png", 1, 1);
	...
	public Move dSpecial(Fighter user) {
		...
		m.setAnimation("sprites/player/dspecial.png", 1, 1);
		m.setContinueOnLanding();
	...
	public Move sSpecial(Fighter user) {
		...
		m.eventList.addConstantVelocity(user, 2, 12, 12, Action.ChangeVelocity.noChange);
		Hitbox early = new Hitbox(user, 6, 2, 13, Hitbox.SAMURAIANGLE, 16, -4, 20, new SFX.HeavyHit());
		Hitbox late = new Hitbox(user, 3, 1, 9, 80, 24, -4, 14, new SFX.MidHit());
		early.setRefresh(6);
		new ActionCircleGroup(Arrays.asList(early, late));
		m.eventList.addActionCircle(early, 4, 8);
	...
	public Move nSpecial(Fighter user) {
		...
		m.setAnimation("sprites/player/nspecial.png", 1, 1);
		m.setContinueOnLanding();
	...
	public Move fThrow(Fighter user){
		...
		m.setAnimation("sprites/player/sweak.png", 1, 1);
		m.dontTurn();
		Hitbox h1 = new Hitbox(user, 4.8f, 0.75f, 8, 50, 16, 0, 20, new SFX.MidHit());
	...
	public Move bThrow(Fighter user){
		...
		m.dontTurn();
		Hitbox h1 = new Hitbox(user, 5, 1, 6, 100, 16, 0, 20, new SFX.MidHit());
		m.eventList.addActionCircle(h1, 0, 1);
		return m;
	}
	...
	public Move uThrow(Fighter user){
		...
		Hitbox h1 = new Hitbox(user, 4, 2, 6, 90, 16, 0, 20, new SFX.MidHit());
		m.eventList.addActionCircle(h1, 0, 1);
		return m;
	}
	...
	public Move dThrow(Fighter user){
		...
		m.dontTurn();
		Hitbox down = new Hitbox(user, 3, 0, 2, 270, 16, 0, 20, new SFX.LightHit());
		Hitbox up = new Hitbox(user, 3, 1.2f, 3, 82, 16, -8, 20, new SFX.MidHit());
	...
	public Move fAirThrow(Fighter user){
		Move m = new Move(user, 18);
		m.setAnimation("sprites/player/fair.png", 1, 1);
		Hitbox h1 = new Hitbox(user, 3, 2.8f, 8, 30, 16, 0, 20, new SFX.MidHit());
		m.eventList.addActionCircle(h1, 0, 1);
		return m;
	}
	...
	public Move bAirThrow(Fighter user){
		Move m = new Move(user, 18);
		m.setAnimation("sprites/player/jump.png", 1, 1);
		m.dontTurn();
		Hitbox h1 = new Hitbox(user, 3, 2.4f, 8, 150, 24, -12, 20, new SFX.MidHit());
	...
	public Move uAirThrow(Fighter user){
		...
		Hitbox h1 = new Hitbox(user, 4, 1.5f, 7, 90, 16, 0, 20, new SFX.MidHit());
		m.eventList.addActionCircle(h1, 0, 1);
	...
	public Move dAirThrow(Fighter user){
		...
		Hitbox down = new Hitbox(user, 4, 4, 12, 280, 16, 0, 20, new SFX.HeavyHit());
		m.eventList.addActionCircle(down, 0, 1);
