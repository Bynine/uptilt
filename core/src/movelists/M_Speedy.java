...
public class M_Speedy extends MoveList {
	...
	public Move nWeak() {
		...
		m.setAnimation("sprites/fighters/speedy/stand.png", 1, 1);
		Hitbox h1 = new Hitbox(user, 1, 0.5f, 3, Hitbox.SAMURAIANGLE, 38, 2, 12, new SFX.MidHit());
	...
	public Move dWeak() {
		...
		m.eventList.addActionCircle(h1, 9, 11);
		return m;
	}
	...
	public Move slide() {
		...
		m.setAnimation("sprites/fighters/speedy/dash.png", 1, 1);
	...
	public Move sCharge() {
		...
		m.setContinueOnLanding();
		m.setAnimation("sprites/fighters/speedy/dash.png", 1, 1);
		Hitbox rotate = 	new Hitbox(user, 6.5f, 0, 1, 30, 32, 0, 18, new SFX.LightHit());
		rotate.setRefresh(3);
		Hitbox finisher = 	new Hitbox(user, 4, 1.5f, 7, 35, 20, 0, 24, new SFX.MidHit());
		m.eventList.addConstantVelocity(user, 10, 30, 8, -user.getGravity());
		m.eventList.addActionCircle(rotate, 10, 25);
		m.eventList.addActionCircle(finisher, 26, 30);
		return m;
	}
	...
	public Move uSpecial() {
		Move m = new Move(user, 20);
		m.eventList.addVelocityChange(user, 6, Action.ChangeVelocity.noChange, 8);
		return m;
	}
